...
(cl:in-package ros_essential_cpp-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <IoTSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IoTSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_essential_cpp-msg:<IoTSensor> is deprecated: use ros_essential_cpp-msg:IoTSensor instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_essential_cpp-msg:id-val is deprecated.  Use ros_essential_cpp-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_essential_cpp-msg:name-val is deprecated.  Use ros_essential_cpp-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_essential_cpp-msg:temperature-val is deprecated.  Use ros_essential_cpp-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_essential_cpp-msg:humidity-val is deprecated.  Use ros_essential_cpp-msg:humidity instead.")
  (humidity m))
